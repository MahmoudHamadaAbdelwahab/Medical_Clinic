<?php
    ...
    if(isset($_POST['update'])){
        ...
        $update = "UPDATE doctor SET doctorName='$name' , doctorPhone='$Phone', doctorDate='$date' , doctorImage='$image_up', doctor_booking_price='$price' , depart_id = '$depart' WHERE doctorId=$Id";
